...
// export const ONE_TOKEN_AT_A_TIME =
//   retrieveEnvVariable("ONE_TOKEN_AT_A_TIME", logger) === "true";
export const COMPUTE_UNIT_LIMIT = Number(
  retrieveEnvVariable("COMPUTE_UNIT_LIMIT", logger),
);
export const COMPUTE_UNIT_PRICE = Number(
  retrieveEnvVariable("COMPUTE_UNIT_PRICE", logger),
);
// export const PRE_LOAD_EXISTING_MARKETS =
//   retrieveEnvVariable("PRE_LOAD_EXISTING_MARKETS", logger) === "true";
// export const CACHE_NEW_MARKETS =
//   retrieveEnvVariable("CACHE_NEW_MARKETS", logger) === "true";
export const TRANSACTION_EXECUTOR = retrieveEnvVariable(
...
// Buy
// export const AUTO_BUY_DELAY = Number(
//   retrieveEnvVariable("AUTO_BUY_DELAY", logger),
// );
export const QUOTE_MINT = retrieveEnvVariable("QUOTE_MINT", logger);
// export const QUOTE_AMOUNT = retrieveEnvVariable("QUOTE_AMOUNT", logger);
export const MAX_BUY_RETRIES = Number(
...
export const SELL_SLIPPAGE = Number(
  retrieveEnvVariable("SELL_SLIPPAGE", logger),
);
